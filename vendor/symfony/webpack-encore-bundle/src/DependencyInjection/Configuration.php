    ...
    public function getConfigTreeBuilder(): TreeBuilder
    {
        ...
        $rootNode
            ...
            ->children()
                ...
                ->end()
                ->booleanNode('preload')
                    ->info('preload all rendered scripts and link tags automatically via the http2 Link header.')
                    ->defaultFalse()
                ->end()
                ->booleanNode('cache')
                ...
                ->arrayNode('script_attributes')
                    ->info('Key/value pair of attributes to render on all scripts tags')
